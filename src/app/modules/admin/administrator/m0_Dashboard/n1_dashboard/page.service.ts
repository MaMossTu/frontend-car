...
export class Service extends BaseService {
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post<any>(`${environment.API_URL}/api/dashboard/service`, dataTablesParameters, this.httpOptions)
            .pipe(map(response => response.data as DataTablesResponse));
    }

    updateStatus(data: any): Observable<any>
    { return this.post('/api/dashboard/service', data); }
}
