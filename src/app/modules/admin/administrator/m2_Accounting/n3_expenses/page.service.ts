...
export class Service extends BaseService {
    ...
    create(data: any): Observable<any> {
        return this.post('/api/cost/add', data);
    }
    createCustomerAddress(data: any): Observable<any> {
        return this.post('/api/customer_add/add', data);
    }
    update(data: any,id: number ): Observable<any> {
        return this.post(`/api/cost/update/${id}`, data);
    }
    delete(id: string): Observable<any> {
        return this._httpClient.delete(
            `${environment.API_URL}/api/cost/delete/${id}`,
            this.httpOptions
        );
    }
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post<any>(
                `${environment.API_URL}/api/Getpage/Expense`,
    ...
    getExpenseTypes(): Observable<any> {
        return this.get('/api/expensetype/show');
    }
    getEmployees(): Observable<any> {
        return this.get('/api/employees/show');
    }
