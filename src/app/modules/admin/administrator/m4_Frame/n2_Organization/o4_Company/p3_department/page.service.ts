...
export class Service {
    ...
    create(data: any): Observable<any> {
        return this._httpClient
            .post(environment.API_URL + '/api/department/add', data, {
                headers: this.httpOptionsFormdata.headers,
            })
            .pipe(
                switchMap((response: any) => {
    ...
    update(data: any, id): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/department/update/' + id,
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/department/delete/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/department/getPage',
