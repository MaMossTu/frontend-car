...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    employeeTypes = [
        { label: 'หน้าร้าน', value: 'front' },
        { label: 'หลังร้าน', value: 'back' },
    ];
    ...
    constructor(
        ...
        this.formData = this._formBuilder.group({
            ...
            hire_day: '',
            is_engineer: [false, Validators.required],
    ...
    async ngOnInit(): Promise<void> {
        ...
        this._Service.getBranchs().subscribe(resp => this.listBranchs = resp);
    }
    ...
    private submitForm(action: (formData: FormData) => Observable<any>): void {
        ...
        if (formValue.hire_day) {
            formValue.hire_day = moment(formValue.hire_day).format('yyyy/MM/DD');
        }
        formValue.is_engineer = formValue.is_engineer ? 1 : 0;
        this._US.submitForm(
