...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    // Province dropdown data
    public listProvinces: any[] = [];

    // Filter state (ส่ง additionalParams ไปยัง server)
    ...
    onFilterChange(): void {
        if (this.filterProvinceId) {
            this.filterParams.province_id = this.filterProvinceId;
        } else {
            delete this.filterParams.province_id;
        }
        this.rerender();
    }
