...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        this.formData = this._formBuilder.group({
            id: '',
            vehicle_inspection_type_id: '',
            vehicle_inspection_type_name: '',
            service_id: '',
            service_name: '',
            weight: '',
            type: '',
        ...
        this.vehicle_inspection_type = this._activatedRoute.snapshot.data.vehicle_inspection_type
        this.service = this._activatedRoute.snapshot.data.service
    }
    ...
    async ngOnInit(): Promise<void> {
        ...
        this._Service.getInspection().subscribe((resp) => { this.listVehicleInspection = resp; });
    }
    ...
    openDialog(id?: any): void {
        ...
        if (id) {
            this._Service.getsettingById(id).subscribe((resp:any) => {
                if (resp.data) {
                    const data = resp.data;
                    this.formData.patchValue({
                        id: data.id,
                        vehicle_inspection_type_id: data.vehicle_inspection_type_id ?? '',
