...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                // this.currentstart = dataTablesParameters
    ...
    pdf() {
        ...
        window.open(`${environment.API_URL}/api/report/reportExportPDFprofit_report?branch_id=1&start_date=${formatSDate}&end_date=${formatEDate}`, '_blank');
    }
