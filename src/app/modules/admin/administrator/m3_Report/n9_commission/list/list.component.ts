...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        this.defaultEndDate = new Date(today);
        this.defaultEndDate.setMonth(this.defaultEndDate.getMonth() - 1);
        this.formData = this._formBuilder.group({
            name: '',
            id: ['', Validators.required],
            start_date: [this.defaultEndDate],
            end_date: [today],
    ...
    pdf() {
        ...
        window.open(`${environment.API_URL}/api/export/commissPDF?start_date=${formatSDate}&end_date=${formatEDate}` );
    }
