...
export class Service extends BaseService {
    ...
    update(data: any, id: string): Observable<any> { return this.post(`/api/Vendor/update/${id}`, data); }
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post<any>(`${environment.API_URL}/api/Vendor/getPage`, dataTablesParameters, this.httpOptions)
