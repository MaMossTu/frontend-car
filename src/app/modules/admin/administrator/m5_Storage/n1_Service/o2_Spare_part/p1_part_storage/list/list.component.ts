...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    constructor(
        ...
        this.productTypes = this._activatedRoute.snapshot.data.productTypes;
    ...
    async ngOnInit(): Promise<void> {
        ...
        this._Service.getItemType().subscribe((resp) => { this.productTypes = resp });
    }
    ...
    private formatForm(): any {
        ...
        Object.entries(this.formData.value).forEach(([key, value]: any[]) => {
            // ตรวจสอบว่าค่าไม่เป็น null หรือ undefined ก่อนที่จะเพิ่มลงใน FormData
    ...
    loadTable(): void {
        ...
        this.dtOptions = {
            ...
            ajax: (dataTablesParameters: any, callback) => {
                dataTablesParameters.type = 'product';
                dataTablesParameters.product_type_id = this.selectedId;
                that._Service
    ...
    excel() {
            ...
            this._US.openPDF(
                `${environment.API_URL}/api/report/excel/exportExcel_sparepartreport?product_type_id=${selectedId}`,
            );
        }
}
