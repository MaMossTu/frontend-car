...
export class Service extends BaseService {
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post<any>(`${environment.API_URL}/api/Getpage/check_gas`, dataTablesParameters, this.httpOptions)
            .pipe(map(response => response.data as DataTablesResponse));
    }

    updateStatus(data: any, id: string): Observable<any> {
        return this.post(`/api/update/inspecions/gas/${id}`, data); }
