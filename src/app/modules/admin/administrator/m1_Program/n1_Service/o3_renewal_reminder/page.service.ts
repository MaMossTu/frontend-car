...
export class Service extends BaseService {
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post<any>(`${environment.API_URL}/api/Getpage/notifications`, dataTablesParameters, this.httpOptions)
            .pipe(map(response => response.data as DataTablesResponse));
    }
    updateCallLog(data: any, id: number): Observable<any> {
        return this.put(`/api/vehicle/update_call_log/${id}`, data);
    }
