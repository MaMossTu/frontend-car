...
export class Service extends BaseService {
    ...
    create(data: any): Observable<any> {
        return this.post('/api/addworkorder', data);
    }
    ...
    update(id: string, data: any): Observable<any> {
        return this.put(`/api/updateworkorder/${id}`, data);
    }
    ...
    //     return this._httpClent.post<any>(`${environment.API_URL}/api/vehicle/brands/getPage`, dataTablesParameters, this.httpOptions)
    //         .pipe(map(response => response.data as DataTablesResponse));
    // }
    ...
    getService() {
        return this._httpClient.get(
            environment.API_URL + '/api/services/showall'
        );
    }
    getService_() {
    ...
    getProvince() {
        return this._httpClient.get(
            environment.API_URL + '/api/provinces/show'
        );
    }
    getDistrict(id: any) {
        return this._httpClient.get(
            environment.API_URL + '/api/provinces/filter/' + id
        );
    }
    getSubdistrict(id: any) {
        return this._httpClient.get(
            environment.API_URL + '/api/districts/filter/' + id
        );
    }
    getVehicleInspection() {
        return this._httpClient.get(
            environment.API_URL + '/api/vehicle/inspection/show'
        );
    }
    getInsuranceType() {
        return this._httpClient.get(
            environment.API_URL + '/api/vehicle/insuranceTypes/show'
        );
    }

    getVehicleBrand() {
        return this._httpClient.get(
            environment.API_URL + '/api/vehicle/brands/show'
        );
    }
    getVehicleModel(id: any) {
        return this._httpClient.get(
            environment.API_URL +
                '/api/vehicle/brands/filter_vehicleModel/' +
                id
        );
    }
    ...
    updateStatus(id: number, data: object) {
        return this._httpClient.put(
            `${environment.API_URL}/api/WorkOrder/update_status/` + id,
            data
        );
    }
    ...
    deleteTransec(id: number) {
        return this._httpClient.delete(
            environment.API_URL + '/api/workorderpayment/delete/' + id
        );
    }
    updatePayment(data: object) {
        return this._httpClient.post(
            `${environment.API_URL}/api/workorderpayment/add`,
            data
        );
    }
    getByworkorder(id:any) {
        return this._httpClient.get(`${environment.API_URL}/api/WorkOrder/showID/`+ id)
    }
}
