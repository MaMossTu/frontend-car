    ...
    theme      : {
        ...
        extend  : {
            ...
            spacing                 : {
                ...
                // Percent values
                ...Array.from({ length: 100 }, (_, i) => i + 1).reduce((acc, n) => {
                    acc[`${n}*`] = `${n}%`;
                    return acc;
                }, {}),

                // ...Array.from({ length: 1000 }, (_, i) => i + 1).reduce((acc, n) => {
                //     acc[`${n}px`] = `${n}px`;
                //     return acc;
                // }, {}),

                // ...Array.from({ length: 480 }, (_, i) => {
                //     const remValue = (i + 1) * 0.25;
                //     return {
                //         [`-mt-${remValue}rem`]: {
                //             marginTop: `-${remValue}rem !important`,
                //         },
                //         [`-mb-${remValue}rem`]: {
                //             marginBottom: `-${remValue}rem !important`,
                //         },
                //         [`-ml-${remValue}rem`]: {
                //             marginLeft: `-${remValue}rem !important`,
                //         },
                //         [`-mr-${remValue}rem`]: {
                //             marginRight: `-${remValue}rem !important`,
                //         },
                //         [`-pt-${remValue}rem`]: {
                //             paddingTop: `-${remValue}rem !important`,
                //         },
                //         [`-pb-${remValue}rem`]: {
                //             paddingBottom: `-${remValue}rem !important`,
                //         },
                //         [`-pl-${remValue}rem`]: {
                //             paddingLeft: `-${remValue}rem !important`,
                //         },
                //         [`-pr-${remValue}rem`]: {
                //             paddingRight: `-${remValue}rem !important`,
                //         },
                //     };
